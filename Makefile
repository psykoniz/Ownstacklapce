# This Makefile is intended *only* for building macOS binaries of OwnStack IDE.
...
app: $(APP_NAME)-native ## Create an OwnStack.app
app-universal: $(APP_NAME)-universal ## Create a universal OwnStack.app
$(APP_NAME)-%: $(TARGET)-%
...
dmg: $(DMG_NAME)-native ## Create an OwnStack.dmg
dmg-universal: $(DMG_NAME)-universal ## Create a universal OwnStack.dmg
$(DMG_NAME)-%: $(APP_NAME)-%
	@echo "Packing disk image..."
	@ln -sf /Applications $(DMG_DIR)/Applications
	@hdiutil create $(DMG_DIR)/$(DMG_NAME) \
		-volname "OwnStack IDE" \
		-fs HFS+ \
		-srcfolder $(APP_DIR) \
		-ov -format UDZO
